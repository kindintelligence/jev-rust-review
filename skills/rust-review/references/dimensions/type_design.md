...
- **Newtype opportunities.** Two parameters of the same primitive type that are easy to swap, such as `(user_id: u64, order_id: u64)`. Units such as ms versus s are another case.
